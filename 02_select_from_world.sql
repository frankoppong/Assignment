...
-- 2. show the name for the countries that have 
...
SELECT name, population/1000000 AS popInMillions
FROM world
...
--7. A country is big if it has an area of more than 3 million sq km or 
